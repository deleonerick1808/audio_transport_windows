...
int main(int argc, char ** argv) {
  ...
  std::cout << "Before calling audiorw::read" << std::endl;
  double sample_rate;
  std::vector<std::vector<double>> audio = audiorw::read(argv[1], sample_rate);
  std::cout << "After calling audiorw::read" << std::endl;
